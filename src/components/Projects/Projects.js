      ...
      <section id="projects" className="project-container">
        <div className="project-cards">
          <div className="card" data-aos="fade-up">
            ...
            <div className="link">
              <a href="https://github.com/DevDeclann/gadgets" target="_blank">Link to project ></a>
            </div>
          </div>
          <div className="card" data-aos="fade-up">
            ...
            <div className="link">
              <a href="https://github.com/SecProjectss/ncNET" target="_blank">Link to project ></a>
            </div>
          </div>
          <div className="card" data-aos="fade-up">
            ...
            <div className="link">
              <a href="https://github.com/DevDeclann/ZoomClone" target="_blank">Link to project ></a>
            </div>
          </div>
          <div className="card" data-aos="fade-up">
            ...
            <div className="link">
              <a href="https://github.com/Front-End-MentorChallenges" target="_blank">Link to project ></a>
            </div>
          </div>
        </div>
      </section>
